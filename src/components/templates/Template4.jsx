...
import Template4pdf from "../PDFs/Template4pdf";
    ...
    <div className="template-wrapper">
      ...
      <Paper className="template-content">
        <div
          ...
          style={{ borderBottom: "2px solid black", color: "#9845bf" }}
        >
          <div>
          ...
          <div className="adress">
            ...
            <div className="template-p">
              <Typography sx={style.Text}>{resume.personalDetails.address}</Typography>
            </div>
            <div className="template-p">
              <Typography sx={style.Text}>
      ...
      <h3>Create File Name</h3>
        ...
        >
          ...
          <Button variant="contained" onClick={handleSubmit}>
            <PDFDownloadLink
              document={<Template4pdf resume={resume} />}
