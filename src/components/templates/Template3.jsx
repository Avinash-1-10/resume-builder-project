...
import Template3pdf from "../PDFs/Template3pdf";
...
const Template3 = ({ userDetails }) => {
  ...
  return (
    <>
      <h2 style={{ textAlign: "center", marginTop: "20px" }}>Resume Preview</h2>
      <div className="template-wrapper">
        <Success success={success} setSuccess={setSuccess} />
        <Paper className="template-content">
          <div
            className="template-container"
            style={{ borderBottom: "2px solid black", color: "#04ba9f" }}
          >
            <div>
            ...
            <div className="adress">
              ...
              <div className="template-p">
                <Typography sx={style.Text}>
                  {resume.personalDetails.pincode},{" "}
        ...
        <div style={{ marginTop: "50px" }}>
          ...
          >
            ...
            <Button variant="contained" onClick={handleSubmit}>
              <PDFDownloadLink
                document={<Template3pdf resume={resume} />}
